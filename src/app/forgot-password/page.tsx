...
const translations = {
    ...
    es: {
        ...
        successMessage:
            "Si tu correo está registrado, recibirás instrucciones para restablecer tu contraseña en breve.",
    },
    fr: {
        ...
        successMessage:
            "Si votre e-mail est enregistré, vous recevrez bientôt des instructions de réinitialisation.",
    },
    it: {
        ...
        successMessage:
            "Se la tua email è registrata, riceverai a breve le istruzioni per reimpostare la password.",
    },
    de: {
        ...
        successMessage:
            "Wenn Ihre E-Mail-Adresse registriert ist, erhalten Sie in Kürze Anweisungen zum Zurücksetzen.",
    },
    pt: {
        ...
        successMessage:
            "Se seu e-mail estiver registrado, você receberá instruções de redefinição em breve.",
    },
};
        ...
        <main className="flex min-h-screen items-center justify-center bg-background dark:bg-gradient-to-br from-background to-secondary">
            ...
            >
                ...
                <div className="mt-4 text-center">
                    <Link
                        href="/"
                        className="flex items-center justify-center text-sm text-primary hover:text-primary-hover"
                    >
